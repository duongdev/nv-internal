  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        system: ['Sans_400Regular', 'Gilroy-Regular', 'ui-sans-serif'],
        ...
        sans: ['Sans_400Regular', 'ui-sans-serif'],
        'sans-bold': ['Sans_700Bold', 'ui-sans-serif'],
        'sans-medium': ['Sans_500Medium', 'ui-sans-serif'],
        'sans-semibold': ['Sans_600SemiBold', 'ui-sans-serif'],
        'sans-extrabold': ['Sans_800ExtraBold', 'ui-sans-serif'],
      },
    },
  },
  future: {
